    ...
    return (
        ...
        >
            ...
            <div className={cl.film__info}>
                <div className={cl.film__short}>{`${filmInfo?.countries[0].country} и еще ${filmInfo?.countries.length}` || `${popularFilm?.countries[0].country} и еще ${popularFilm?.countries.length}`}<span>{filmInfo?.year || popularFilm?.year}</span></div>
